...
class Handler(BaseHTTPRequestHandler):
    ...
    # The wording on the username field. Tests move it to simulate the portal
    # being redesigned under a run that thought it knew where the field was.
...
<form method="post" action="/auth/login">
  <label for="userid">{Handler.username_label}</label><input id="userid" name="userid">
...
class MockSiteVisitPortal:
    ...
    def rename_username_field(self, label: str) -> None:
        """Reword the username field, as a portal redesign would."""
        Handler.username_label = label

    def __enter__(self) -> "MockSiteVisitPortal":
        Handler.expire_session = False
        Handler.username_label = "User Id"
