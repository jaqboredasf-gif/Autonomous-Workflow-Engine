"""Where this installation keeps its things, and whether you are standing in it.
...
MARKERS = ("pyproject.toml", "src/awe_tegg", "config")

#: Override for tests and for anyone running an unusual layout.
ENV_ROOT = "AWE_TEGG_ROOT"
...
def require_installation(cwd: Path | None = None) -> Path:
    ...
    raise NotInInstallation(
        f"this command was started in {here}, which is not inside the TEGG "
