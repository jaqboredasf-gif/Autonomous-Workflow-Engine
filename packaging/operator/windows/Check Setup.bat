@echo off
REM TEGG Report Tool - Check Setup
REM
REM Double-click this file. It runs "Check Setup.ps1" next to it.
...
setlocal
cd /d "%~dp0"
powershell.exe -NoProfile -NoLogo -ExecutionPolicy Bypass -File "%~dp0Check Setup.ps1" %*
